...
/**
 * The position and motion control of a Thunder.
 */
public class Thunder {
	...
	public Thunder(MazeGame game, CellLocation location) {
		this.game = game;
	...
	public void doMove() {
		...
		// Once moved, the game will ask where the Thunder is, as needed.
	}
	...
	private ArrayList<MoveDirection> getPossibleMoves() {
		...
		// Have the Thunder try not to back-track unless needed by making the 
